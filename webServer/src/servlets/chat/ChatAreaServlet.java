...
@WebServlet(name = "ChatAreaServlet", urlPatterns = {"/chatAreaServlet"})
public class ChatAreaServlet extends HttpServlet {
...
//        }
        ...
        synchronized (getServletContext()) {
            //chatManagerVersion = database.getChatManager().getVersion();
            chatEntries = database.getChatManager().getChatEntries(/*chatVersion*/);
        }
