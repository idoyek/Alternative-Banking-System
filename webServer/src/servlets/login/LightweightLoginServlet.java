...
public class LightweightLoginServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        //int currentYaz = Integer.parseInt(request.getParameter("currentYaz"));
        ...
        if (usernameFromSession == null) { //user is not logged in yet
            ...
            if (usernameFromParameter == null || usernameFromParameter.isEmpty()) {
                ...
                synchronized (this) {
                    if (database.getClientsMap().containsKey(usernameFromParameter)) {
                    ...
                    else if (ServletUtils.getHistoryRewind().getIsInRewindMode()){
                        String errorMessage = "The system is in Rewind Mode, you can't login now.";
                        ...
                        Client client = new Client(usernameFromParameter, 0);
                        client.setLoginYaz(database.getYaz().getYaz());
                        database.addClientToMap(client);
