...
import static util.Constants.ADMIN_SCREEN;
...
public class LoginController {
    ...
    public LoginController(){
        screenTypeName = new SimpleStringProperty(ADMIN_SCREEN);
    }
    ...
    @FXML
    void activateLoginButton(ActionEvent event) throws IOException {
