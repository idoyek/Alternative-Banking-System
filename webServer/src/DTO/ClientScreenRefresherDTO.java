...
public class ClientScreenRefresherDTO {
    ...
    private List<Loan> loansForSaleList;
...
/*
        ...
        this.loansForSaleList = new ArrayList<>(loansForSaleList);
...
*/
    ...
    public List<Loan> getLoansForSaleList() {
